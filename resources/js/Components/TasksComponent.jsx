                ...
                <div className="bg-white rounded-xl shadow-sm p-8 mb-8">
                    ...
                    {loading ? (
                        ...
                        <>
                            ...
                            <div className="p-6">
                                {/* Transparent grey overlay with pointer-events: none to prevent clicking */}
                                <div className="relative bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
                                    {/* Absolute overlay to prevent interactions */}
                                                        ...
                                                        if (
                                                            ...
                                                            return (
                                                                <div
                                                                    ...
                                                                    className="bg-white border border-gray-100 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden cursor-not-allowed"
                                                                >
                                                                    <div className="p-5 border-b border-gray-100">
                                                                        <div className="flex justify-between items-start mb-3">
                                                                            <h3 className="text-lg font-semibold text-gray-800 line-clamp-1">
                                    ...
                                    {/* Optional: Add a message indicating this is non-interactive */}
                                    <div className="absolute top-2 right-2 bg-gray-100 text-gray-500 px-3 py-1 rounded-md text-xs font-medium">
                                        Read Only
                                    </div>
                                </div>
                            </div>
