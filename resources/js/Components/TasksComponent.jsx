                            ...
                            <div className='mb-12'>
                                ...
                                {tasks.some(task => task.status === 'in-progress' || task.status === 'pending') ? (
                                    ...
                                    <div className='bg-blue-50 border border-blue-100 rounded-lg p-6 text-center'>
                                        ...
                                        <p className='text-blue-800 text-lg font-medium'>No active tasks assigned to you at the moment.</p>
                                        <p className='text-blue-600 mt-1'>All your tasks are either completed or not yet assigned.</p>
                                    </div>
                                )}
                            </div>
                            ...
                            <div>
                                ...
                                {tasks.some(task => task.status === 'completed') ? (
                                    ...
                                    <div className='bg-green-50 border border-green-100 rounded-lg p-6 text-center'>
                                        ...
                                        <p className='text-green-800 text-lg font-medium'>No completed tasks yet.</p>
                                        <p className='text-green-600 mt-1'>Your completed tasks will appear here.</p>
                                    </div>
                                )}
                            </div>
                        </>
                        ...
                        <div className='p-6'>
                            ...
                            <div className='mb-6'>
                                <div className='flex items-center mb-2'>
                                    ...
                                    <div className='ml-2'>{getStatusBadge(selectedTask.status)}</div>
                                </div>
