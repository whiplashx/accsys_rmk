...
export default function Sidebar() {
    ...
    <>
        ...
        <div className="lg:hidden fixed flex top-0 left-0 z-50 w-full bg-green-800 p-4 flex justify-between items-center">
                    ...
                    <span className="text-white text-lg font-bold">Accreditation</span>
                </div>
...
>
    ...
    <nav className="mt-6">
        {/* Nav Links */}
        <ul className=''>
                        <li className="px-4 py-3 hover:bg-green-200">
                            <NavLink 
                                href={route('dashboard')} 
                                active={route().current('dashboard')}
                                className="flex items-center space-x-2 text-gray-700 hover:text-green-900"
                            >
                        ...
                        <li className="px-4 py-3 hover:bg-green-50">
                            <NavLink 
                                href={route('dashboard')} 
                                active={route().current('dashboard')}
